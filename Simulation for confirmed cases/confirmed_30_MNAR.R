...
for (i in 1:N_sim){
  ...
  merged_data$logit_30 <- -0.506 * merged_data$event - 0.59
...
# write.csv(mnar_30_prob, "/Users/apple/Desktop/new_full_data/simulation/confirmed_30_MNAR_simulation.csv")
library(rsimsum)
...
result_30 %>% flextable() %>% 
  ...
  flextable::save_as_docx(path = "/Users/apple/Desktop/new_full_data/simulation/confirmed_table_30.docx")
