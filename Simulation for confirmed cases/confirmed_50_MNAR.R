...
for (i in 1:N_sim){
  ...
  merged_data$logit_50 <- -0.506 * merged_data$event + 0.3551
...
# write.csv(mnar_50_prob, "/Users/apple/Desktop/new_full_data/simulation/confirmed_50_MNAR_simulation.csv")
library(rsimsum)
...
result_50 %>% flextable() %>% 
  ...
  flextable::save_as_docx(path = "/Users/apple/Desktop/new_full_data/simulation/confirmed_table_50.docx")
