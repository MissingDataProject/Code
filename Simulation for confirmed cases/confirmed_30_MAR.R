...
for (i in 1:N_sim){
  ...
  # MAR - 30%
  merged_data$logit <- -1.307 + 0.0141 * merged_data$age_years + 0.03006 * as.numeric(merged_data$sex)
...
# write.csv(mar_30_prob_MAR, "/Users/apple/Desktop/new_full_data/simulation/confirmed_30_MAR_simulation.csv")
library(rsimsum)
