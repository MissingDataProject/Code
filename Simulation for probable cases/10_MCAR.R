...
for (i in 1:N_sim){
  ...
  mcar_10_mi_prob <- rbind(mcar_10_mi_prob, mcar_x10_mi_prob_each_run)
...
# write.csv(mcar_10_prob, "/Users/apple/Desktop/new_full_data/simulation/10_MCAR_simulation.csv")
library(rsimsum)
