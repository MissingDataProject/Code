...
for (i in 1:N_sim){
  ...
  # MAR - 50%
  merged_data$logit <- 0.4304 + (-0.01411)  * merged_data$age_years + 0.01560 * as.numeric(merged_data$sex)
...
# write.csv(mar_50_prob_MAR, "/Users/apple/Desktop/new_full_data/simulation/confirmed_50_MAR_simulation.csv")
library(rsimsum)
